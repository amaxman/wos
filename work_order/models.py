...
class WorkOrderStaff(BasicModel):
    ...
    work_order_percent = models.DecimalField(verbose_name=_('Update Time'), max_digits=5, decimal_places=2, default='0')
    create_by = models.ForeignKey(to=User, verbose_name=_('Work Order Staff Percent'), on_delete=models.SET_NULL, null=True,
