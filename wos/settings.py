...
SECRET_KEY = 'django-insecure-rjas9q!zug)7p=u(y5k%2wis^rs0x*6qp3$xk(e$4%du3it&o7'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # 默认允许所有访问，生产环境需调整
    ],
