...
#### 经过2周的测试，开发效率上Python+django+djangorestframework 似乎不适合互联网系统的开发。但是，这不妨碍本项目作为初学者入门项目。
#### 关于开发路线，各位同行仁者见仁、智者见智。

# 项目方向更换
#### 基于多方考虑，将暂停维护本项目，工单wos项目将迁移至Java方向，并采用SpringBoot全家桶来实现。请参看项目wos_java，本项目将继续开源。
